...
{
    original_future: F,
    result: Option<Result<Async<SharedItem<F::Item>>, SharedError<F::Error>>>,
    tasks_receiver: Mutex<Receiver<Task>>,
}
    ...
    Shared {
        inner: Arc::new(Inner {
            synced_inner: RwLock::new(SyncedInner {
                ...
                result: None,
                tasks_receiver: Mutex::new(tasks_receiver),
            }),
            ...
            match self.inner.synced_inner.try_read() {
                Ok(inner_guard) => {
                    ...
                    match inner.tasks_receiver.try_lock() {
                        ...
                        Err(_) => {} // Other thread is unparking the tasks
                    }
