...
impl Future for Never {
    ...
    fn poll(&mut self, _: &mut task::Context) -> PollResult<Never, Never> {
        match *self {}
    }
}
...
impl Stream for Never {
    ...
    fn poll_next(&mut self, _: &mut task::Context) -> PollResult<Option<Never>, Never> {
        match *self {}
    }
}
